...
<div class="body-wrapper">
 ...
 <section class="refund-section">
    <div class="refund-content">
      <h1>Refund Policy</h1>
      <p>
        All payments made through our website are considered final and non-refundable. Once a payment has been processed, we are unable to offer refunds, except in exceptional cases of a genuine error such as:
      </p>
  
      <ul>
        <li>Duplicate transaction</li>
        <li>Incorrect amount entered</li>
        <li>Technical error in the transaction process</li>
      </ul>
  
      <p>
        If you believe your payment was made in error, please contact us within <strong>7 days</strong> of the transaction. We will review your request and, if eligible, We will process a refund accordingly. Approved refunds will be credited to your original payment method within <strong>5–7</strong> business days.
      </p>
  
      <h2>Contact Us</h2>
      <p>
        For any concerns or queries regarding your payment refund, please reach out to us at:
      </p>
      <p>
        <strong>Email:</strong> <a href="mailto:capitalsatara@gmail.com">capitalsatara@gmail.com</a><br/>
        <strong>Phone:</strong> +91 92846 01662
      </p>
