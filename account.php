...
<div class="body-wrapper">
    ...
    <div class="liton__wishlist-area pb-70">
                                ...
                                <div class="col-lg-4">
                                    <div class="ltn__tab-menu-list mb-50">
                                        <div class="nav">                                            
                                            ...
                                            <a href="#" onclick="window.location='add-listing-gateway.php'">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="ltn_tab_1_1">
                                            <div class="ltn__myaccount-tab-content-inner">
                                                <p>Hello <strong><?php echo $_SESSION['firstname']; ?>
                                                            ...
                                                            <div class="footer-address">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div class="footer-address-info">
                                                                            <p><?php echo $_SESSION['mobile'] ?? ''; ?></a></p>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="footer-address-icon">
                                                    ...
                                                    <form action="#">
                                                        <div class="row mb-50">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="email" name="ltn__lastname" placeholder=<?php echo $_SESSION['email'] ?? ''; ?>>
                                                            </div>
                                                        </div>
        ...
        <input type="password" name="confirm_password" required>
                                                                    <button type="submit" name="change_btn" class="btn btn-primary mt-3">
                                                                            Change Password
                                                                         </button>
                                                                </div>
                                                            </div>
