                                ...
                                <div class="ltn__product-tab-content-inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select" name="loan">
                                                    <option>Loan</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select" name="parking">
                                                    <option>Parking</option>
                                                    <option>2 Wheelar</option>
                                                    <option>4 Wheelar</option>
