...
if (isset($_POST["btn-save"])) {
    ...
    $file_upload = $_FILES["listing_image"]["name"]; // file handling can be expanded
    $video_from = $_POST["video_from"];
    ...
    $preferred_tenants = $_POST["preferred_tenants"];
    ...
    $bhk = $_POST["bhk"];
    $floors_no = $_POST["floors_count"];
    $furnished_status = $_POST["furnishing_status"];
    $property_status = $_POST["property_status"];

    // Convert checkbox arrays to JSON
    $interior_details = json_encode($_POST["interior_details"]);
    $outdoor_details = json_encode($_POST["outdoor_details"]);
    $utilities = json_encode($_POST["utilities"]);
    $other_features = json_encode($_POST["other_features"]);

    // File upload (optional — ensure uploads dir is writable)
    ...
    // Prepare SQL
    $sql = "INSERT INTO residential_rent (
        title, description, price, price_negotiable,
        category, listing_type, file_upload, video_from, video_id, virtual_tour,
        address, country, state, city, neighborhood, zip,
        agreement_type, rooms, bedrooms, bathrooms, security_deposit, maintenance_charges, year_built, preferred_tenants, available_from, floor_number,
        carpet_area, verification_status, balconies, bhk, floors_no, furnishing_status, property_status,
        interior_details, outdoor_details, utilities, other_features
    ) VALUES (
        '$title', '$description', '$price', '$price_negotiable',
        '$category', '$listing_type', '$file_upload', '$video_from', '$video_id', '$virtual_tour',
        '$address', '$country', '$state', '$city', '$neighborhood', '$zip',
        '$agreement_type', '$rooms', '$bedrooms', '$bathrooms', '$security_deposit', '$maintenance_charges', '$year_built', '$preferred_tenants', '$available_from', '$floor_number',
        '$carpet_area', '$verification_status', '$balconies', '$bhk', '$floors_no', '$furnished_status', '$property_status',
        '$interior_details', '$outdoor_details', '$utilities', '$other_features'
    )";
                    ...
                    <div class="tab-content">
                            <div class="ltn__apartments-tab-content-inner">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                            <input type="text" name="price" placeholder="Price in ₹ (only numbers)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="price_negotiable">
                                                <option selected disabled>Price Negotiable</option>
                                                <option>YES</option>
                                                <option>NO</option>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="listing_type">
                                                <option>None</option>
                        ...
                        <div>
                            <div class="ltn__product-tab-content-inner">
                                <h6>Listing Media</h6>
                                <input type="file" id="myFile" name="listing_image" class="btn theme-btn-3 mb-10"><br>
                                <p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="video_from">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                            <input type="text" name="video_id" placeholder="Embed Video ID">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h6>Virtual Tour</h6>
                                <div class="input-item input-item-textarea ltn__custom-icon">
                                    <textarea name="virtual_tour" placeholder="Virtual Tour:"></textarea>
                                </div>
                        ...
                        <div>
                            <div class="ltn__product-tab-content-inner">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="maintenance_charges">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                            <input type="text" name="year_built" placeholder="Year Built (*numeric)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-item">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                            <input type="text" name="floor_number" placeholder="Property floor number (*text)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="carpet_area">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="verification_status">
                                                <option>Verification Status</option>
                                                <option>Verified Property</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="balconies">
                                                <option>How Many Balcony</option>
                                                <option>0</option>
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="bhk">
                                                <option>How Many BHK</option>
                                                <option>One RK</option>
                                                <option>1 BHK</option>
                                                <option>2 BHK</option>
                                                <option>3 BHK</option>
                                                <option>4 BHK</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item">
                                            <select class="nice-select" name="floors_count">
                        ...
                        <div>
                            <div class="ltn__product-tab-content-inner">
                                ...
                                <div class="btn-wrapper text-center--- mt-30">
                                    <!-- <button class="btn theme-btn-1 btn-effect-1 text-uppercase" name="btn-save" type="submit">Submit & Pay Now</button> -->
                                     <button onclick="window.location.href='checkout.php';" class="btn theme-btn-1 btn-effect-1 text-uppercase" type="button">Submit & Pay Now</button>
                                </div>
                            </div>
                        </div>
