                                ...
                                <div class="ltn__apartments-tab-content-inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select">
                                                    <option>Price Negotiable</option>
                                                    <option>YES</option>
                                                    <option>NO</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="ltn__product-tab-content-inner">
                                            <h6>Legal Certificate Uploads</h6>
                            ...
                            <div>
                                <div class="ltn__product-tab-content-inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Plot Area (*only numbers)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Booking Amount (*only numbers)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <!-- <div class="input-item input-item-textarea ltn__custom-icon">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select">
                                                    <option>Financing Available</option>
                                                    <option>YES</option>
                                                    <option>NO</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select">
                                                    <option>Property Approval</option>
                                                    <option>RERA Approved</option>
                                                    <option>Municipal Approved</option>
                                        ...
                                        <!-- <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Property floor number (*text)">
                                            </div>
                                        </div> -->
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
...
<!--                                         
                            ...
                            <div>
                                <div class="ltn__product-tab-content-inner">
                                    ...
                                    <div class="row">                                
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Electricity Connection
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Water Supply
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Drainage/Sewer
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Road Access
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Fencing/Boundary Wal
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">                                
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Environmental Clearance
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <label class="checkbox-item">Survey & Approval Docs
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
