                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-item">
                                                <select class="nice-select">
                                                    ...
                                                    <option>Office Space Suit</option>
                                                    <option>Shop Suite</option>
                                                    <option>Showroom Suite</option>
                                                    <Option>Warehouse Suite</Option>
                                                    <Option>Industrial Shed Suite</Option>
                                                    <Option>Commercial Building Suite</Option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Yearly Tax Rate (*numeric)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Suite Number (*numeric)">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="ltn__product-tab-content-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="ltn__name" placeholder="Size in SQ ft (*only numbers)">
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
