...
<div class="body-wrapper">
    ...
    <section class="add-listing-gateway">
        <div class="gateway-container">
          <h2 class="gateway-title">Select Property Type</h2>
          <div class="property-type-toggle">
            <button class="toggle-btn active" data-target="residential">Residential</button>
            <button class="toggle-btn" data-target="commercial">Commercial</button>
            <button class="toggle-btn" data-target="land">Land/Plot</button>
            <button class="toggle-btn" data-target="suite">Suite Property</button>
          </div>
            
             <h2 class="gateway-title">What do you want to do?</h2>
          <div class="property-suboptions" id="residential">
            <a href="property_form.php?form_type=resi_rent" class="suboption-btn">Rent</a>
            <a href="property_form.php?form_type=resi_sell" class="suboption-btn">Sale</a>
            <a href="property_form.php?form_type=resi_buy" class="suboption-btn">Buy</a>
          </div>
          
          <div class="property-suboptions hidden" id="commercial">
            <a href="property_form.php?form_type=comm_rent" class="suboption-btn">Rent</a>
            <a href="property_form.php?form_type=comm_sell" class="suboption-btn">Sale</a>
            <a href="property_form.php?form_type=comm_buy" class="suboption-btn">Buy</a>
          </div>
          
          <div class="property-suboptions hidden" id="land">
            <a href="property_form.php?form_type=land_rent" class="suboption-btn">Rent</a>
            <a href="property_form.php?form_type=land_sell" class="suboption-btn">Sale</a>
            <a href="property_form.php?form_type=land_buy" class="suboption-btn">Buy</a>
          </div>
          
          <div class="property-suboptions hidden" id="suite">
            <a href="property_form.php?form_type=suit" class="suboption-btn">Sale</a>
          </div>
...
const suboptionGroups = document.querySelectorAll('.property-suboptions');
...
toggleBtns.forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    // Hide all suboptions
    suboptionGroups.forEach(group => group.classList.add('hidden'));
