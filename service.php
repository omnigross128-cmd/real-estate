                    ...
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2--- mb-20">
                            ...
                            <h1 class="section-title">The Leading Real Estate
                                Marketplace cres99<span>.</span></h1>
                            <p>At Capital Real Estate Satara, we revolutionize the industry with an unparalleled approach to property management.</p>
                        </div>
                        <div class="about-us-info-wrap-inner about-us-info-devide---">
                            <p>Our expertise spans across Satara and its neighboring areas, offering a comprehensive suite of services that cater to every client's needs. Whether you're a seasoned investor seeking lucrative ventures or a first-time homeowner searching for a cozy abode, our dedicated team tailors solutions, ensuring a smooth and transparent journey. We are committed to providing exceptional experiences, guaranteeing lasting partnerships built on trust, integrity, and unwavering commitment to your real estate aspirations</p>
                        </div>
                        <div class="btn-wrapper animated">
                            <a href="about.php" class="theme-btn-1 btn btn-effect-1 text-uppercase">About Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row  justify-content-center">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            ...
                            <p>From tenant screening to rent collection and maintenance, our experts manage your property like it’s their own.</p>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            ...
                            <p>Smart financing starts here — find the right mortgage for your dream home.
                            Compare rates, get expert guidance, and secure home loans with ease and confidence.</p>
                            <!-- <a class="ltn__service-btn" href="service-details.php">Find A Home <i class="flaticon-right-arrow"></i></a> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            ...
                            <p>From investment planning to legal guidance, our consultants help you make smarter property decisions.</p>
                            <!-- <a class="ltn__service-btn" href="service-details.php">Find A Home <i class="flaticon-right-arrow"></i></a> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            <h3>Buying</h3>
                            <p>Explore listings, get financing guidance, and close the deal with confidence through expert support.</p>
                            <!-- <a class="ltn__service-btn" href="service-details.php">Find A Home <i class="flaticon-right-arrow"></i></a> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            <h3>Selling</h3>
                            <p>From pricing to promotion, our tools and experts help you sell your property quickly and profitably.</p>
                            <!-- <a class="ltn__service-btn" href="service-details.php">Find A Home <i class="flaticon-right-arrow"></i></a> -->
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        ...
                        <div class="ltn__feature-info">
                            <h3><a href="service-details.php">Escrow Services</a></h3>
