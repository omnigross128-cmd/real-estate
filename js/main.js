...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        */
        ...
        $('.ltn__image-slider-netflix-active').slick({
            slidesToShow: 6,
            slidesToScroll: 2,
            arrows: true,
            dots: false,
            ...
            prevArrow:
                '<button class="netflix-prev"><i class="fas fa-chevron-left"></i></button>',
            nextArrow:
                '<button class="netflix-next"><i class="fas fa-chevron-right"></i></button>',
